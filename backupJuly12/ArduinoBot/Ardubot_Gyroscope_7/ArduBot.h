...
struct moveRobotOutputs moveRobot(int x, int y, int z, float gyro=0) { //taking x, y, (-1000 to 1000), and gyro (in milliradians, 0 to 6283) values, runs the motors at speeds to move robot in correct direction
  struct motorspeeds speeds;
  struct axis axis;
