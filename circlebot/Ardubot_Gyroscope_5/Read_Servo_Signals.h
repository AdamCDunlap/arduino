...
volatile unsigned int pulseTime1; //AILE RX
volatile unsigned int pulseTime2; //THRO LY
volatile unsigned int pulseTime3; //ELEV RY
volatile unsigned int pulseTime4; //RUDD LX
