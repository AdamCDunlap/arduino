...
byte smiley[8] = {               // Define a picture of a smiley face
  B00111100,
  B01000010,
  B10100101,
  B10000001,
...
PROGMEM prog_uchar heart[8] = {  // Define a picture of a heart in program memory, so it does not take up valuable RAM
  B01100110,
  B11011011,
  B11000011,
  B11000011,
...
void loop()                      // Run this forever
{
  ...
  disp.println("SCROLL..."); // Print the word "SSCCRROOLL..." to the display
  
  disp.print(3.1415926);         // Print part of pi to the display
  disp.print(147, BYTE);         // Print the ASCII code 147 to the display - o with circumflex, but font may be different
  delay(500);
} 
